...
function VinylItem({ name, count, uri, currentContextUri, onPlay, imageUrl, isLiked }: VinylItemProps) {
  const isActive = currentContextUri === uri;
  return (
    <div className={[styles.item, isActive ? styles.active : ""].join(" ")} onClick={() => onPlay(uri)}>
