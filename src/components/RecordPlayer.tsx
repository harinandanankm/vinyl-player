    ...
    <div className={styles.turntable}>
      ...
      <div className={styles.topSection}>
        ...
        <div className={styles.platterArea}>
              ...
              <div className={styles.artRing}>
                {albumArt ? (
                  ...
                  <div className={styles.artPlaceholder}>
                    {trackName.substring(0, 4).toUpperCase()}
                  </div>
                )}
              </div>
          ...
          <div className={styles.tonearmWrap} aria-hidden="true">
            ...
            <svg
              className={`${styles.tonearmSvg} ${isPlaying || track ? styles.tonearmOn : ""}`}
              viewBox="0 0 120 260"
              fill="none"
            >
        ...
        <div className={styles.infoPanel}>
          ...
          <div className={styles.infoBottom}>
            ...
            <div className={styles.rpmRow}>
              ...
              <span className={styles.sdkStatus}>
                {sdkReady ? "SDK Ready" : "Connecting SDK…"}
              </span>
            </div>
          </div>
        </div>
      ...
      <div className={styles.controls}>
        ...
        <div className={styles.btnRow}>
          <button className={styles.ctrlBtn} onClick={onPrev} aria-label="Previous track">
            <PrevIcon />
          </button>
          <button
          ...
          <button className={styles.ctrlBtn} onClick={onNext} aria-label="Next track">
            <NextIcon />
          </button>
        </div>
